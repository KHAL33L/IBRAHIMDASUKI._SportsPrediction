...
# my model
file_path = r"C:\Users\HP\Desktop\Intro to AI\fifa_rating_predictor.joblib"
model = joblib.load(file_path)

# setting common features
common_features = ['age', 'skill_ball_control', 'skill_long_passing', 'power_shot_power', 'potential', 'attacking_short_passing', 'mentality_vision', 'movement_reactions', 'mentality_composure']
...
def preprocess(data):
    ...
    for feature in common_features:
        if feature not in input_df.columns:
            input_df[feature] = 0
    return input_df[common_features]
